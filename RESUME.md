     Avijit Singh
     avijitsingh704@gmail.com
     (570)-362-8147
     Boston, MA 02120
     Available: January - July 2026
...
TECHNICAL SKILLS	
     ...
     •	Languages: Java, Kotlin, XML, C#, Python, TypeScript, CSS, HTML, and SQL
...
•	Applied decision-making algorithms to simulate intelligent gameplay and enhance challenge 
  for the player.
...
•	Created interactive sprites and collectables to gamify studying and motivate users.
•	Built multiple screens and timed notifications to encourage breaks and maintain focus.
...
•	Collaborated with engineers to integrate software with hardware and troubleshoot technical 
  issues.
•	Mentored three underclassmen on the codebase, robot mechanics, and programming strategies. 
...
•	Collaborated with a PhD candidate to support an independent research project that examined 
  ...
  inform projections.
•	Synthesized data and insights to evaluate potential benefits and trade-offs of AI adoption,
  supporting evidence-based conclusions for the study.
